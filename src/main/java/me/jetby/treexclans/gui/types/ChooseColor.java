...
public class ChooseColor extends TGui {
            ...
            if (selectedButton != null) {
                ...
                registerItem(selectedButton.id() + selectedButton.slot(), builder -> {
                    ...
                    builder.defaultClickHandler((event, controller) -> {
                        ...
                        if (finalSelectedButton.type().startsWith("color-")) {
                            Member member = clan.getMember(player.getUniqueId());

                            Color color = Equipment.getColorByName(finalSelectedButton.type().replace("color-", ""));
